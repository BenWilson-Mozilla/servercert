...
| **#** | **Description of Circumstance for Revocation** | **Revocation Timeline** | **RFC 5280 `reasonCode`** |
| :---: | --- | --- | :---: |
...
| 5 | The Subscriber requests revocation because the subject or system represented in the Certificate has permanently ceased operation with no indication of key compromise. | SHOULD within 24 hours, but MUST within 5 days | `cessationOfOperation` (5) |
| 6 | The Subscriber requests revocation without specifying a reason or the reason for revocation does not fall within any of the revocation reason codes listed above in this section. | SHOULD within 24 hours, but MUST within 5 days | `unspecified` (0) |
